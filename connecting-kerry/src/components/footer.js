      ...
      <div className={styles.footerContainer}>
        <div className={styles.row}>
          ...
          <div className={styles.column}>
            ...
            <a className={styles.footerLink} href="#">Navigation</a>
            <a className={styles.footerLink} href="#">Home</a>
            <a className={styles.footerLink} href="#">About</a>
            <a className={styles.footerLink} href="#">Volunteer Services</a>
          </div>

          <div className={styles.column}>
            <p className={styles.heading}>Contact Us</p>
            <a className={styles.footerLink} href="#">Contact</a>
            <a className={styles.footerLink} href="#">Garda Vetting</a>
            <a className={styles.footerLink} href="#">Training</a>
          </div>
